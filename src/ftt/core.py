...
class FileTypeTester:
    ...
    def test_file(self, filepath: Union[str, Path]) -> TestResult:
        """
        ...
        return TestResult.success_result(
            FileType(category=FileTypeCategory.DATA, description="data")
        )

    def test_files(self, filepaths: List[Union[str, Path]]) -> List[TestResult]:
        """
    ...
    def format_result(self, filepath: Union[str, Path], result: TestResult) -> str:
        """
    ...
    def classify_file(self, filepath: Union[str, Path]) -> Optional[FileType]:
        """
